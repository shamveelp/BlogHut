  ...
  return (
    <div className="relative flex items-center" ref={containerRef}>
      ...
      {isOpen && typeof document !== "undefined" && createPortal(
        <div className="md:hidden fixed inset-0 z-[2000] bg-background/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-card w-full max-w-sm rounded-2xl shadow-2xl border border-border flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              {query.trim() ? (
                <div className="flex flex-col">
                  ...
                  {!isSearching && results.map((blog) => (
                    ...
                    >
                      <div className="w-12 h-12 shrink-0 rounded-lg overflow-hidden relative bg-muted">
                        <PostImage seed={blog.cover_image || "a"} alt={blog.title} />
                      </div>
                      <div className="flex flex-col min-w-0">
                        <h4 className="text-sm font-bold text-foreground truncate">{blog.title}</h4>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center bg-muted/5">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-muted/30 mb-3"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
